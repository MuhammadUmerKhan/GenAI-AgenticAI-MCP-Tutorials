...
DB_PATH = os.path.join(os.path.dirname(__file__), "database" if os.path.exists("database") else os.mkdir("database"), "chatbot.db")
...
tools = [search_tool, *mcp_tools, get_stock_price]
